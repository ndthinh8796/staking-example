...
export interface NDTTokenInterface extends utils.Interface {
  contractName: "NDTToken";
  functions: {
...
export interface NDTToken extends BaseContract {
  contractName: "NDTToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NDTTokenInterface;
